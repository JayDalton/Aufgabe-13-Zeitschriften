...
public class Namen
{
  ...
  */
  //############################################################################
  public String erzeugeNamen()
  {
    Generator zufall1 = new Generator(0, rufname.length - 1);
    String name1 = rufname[zufall1.ganzzahl()];

    Generator zufall2 = new Generator(0, famname.length - 1);
    String name2 = famname[zufall2.ganzzahl()];
